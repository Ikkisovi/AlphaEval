...
def main():
    ...
    if os.path.exists(BASE_DATA_FILE):
        ...
        # Apply universe filter if UNIVERSE_STOCKS is defined in config
        try:
            universe_filter = UNIVERSE_STOCKS
            print(f"Filtering to {len(universe_filter)} universe stocks: {universe_filter[:5]}...")
        except NameError:
            universe_filter = None
            print("No UNIVERSE_STOCKS defined - processing all symbols")
