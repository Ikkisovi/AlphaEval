...
# Fix PyArrow timezone issue on Windows before importing pyarrow
try:
    import pyarrow_hotfix  # noqa: F401 - Import to apply hotfixes
except ImportError:
    pass
...
def load_features(out_dir, start, end, feature_patterns=None, symbols=None, sessions=None):
    ...
    if symbols is not None:
        ...
        df = df[df['symbol'].str.lower().isin(symbols_lower)]
